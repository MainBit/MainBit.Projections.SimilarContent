...
namespace MainBit.Projections.SimilarContent.Providers.Filters {
    public class ContentFieldsFilter : IFilterProvider {
        ...
        public ContentFieldsFilter(
            ...
            IEnumerable<MainBit.Projections.SimilarContent.FieldTypeEditors.IFieldTypeEditor> mainbitFieldTypeEditors,
            ITokenizer tokenizer,
            ICurrentContentAccessor currentContentAccessor)
        {
            _contentDefinitionManager = contentDefinitionManager;
            _contentFieldDrivers = contentFieldDrivers;
            _mainbitFieldTypeEditors = mainbitFieldTypeEditors;
        ...
        public void ApplyFilter(FilterContext context,
            MainBit.Projections.SimilarContent.FieldTypeEditors.IFieldTypeEditor fieldTypeEditor,
            string storageName,
            Type storageType,
            ...
            ContentPartFieldDefinition field)
        {
            ...
            //{
            //    tokens.Add("Content", _currentContentAccessor.CurrentContentItem);
            //}
            // context.State - is not string - it is error
            //var tokenizedState = _tokenizer.Replace(context.State, tokens);
